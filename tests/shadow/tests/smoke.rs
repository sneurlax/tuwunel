...
use shadow_test_harness::{
	config::{
		shadow::{General, Host, HostOptionDefaults, Network, Process, ShadowConfig},
...
fn shadow_smoke() {
	...
	// Per CONF-03: isolated tempdir for RocksDB via relative
	// database_path Per Pitfall 4: relative database_path resolves
	// from Shadow host CWD
